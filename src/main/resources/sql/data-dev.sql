...
('5c21433c-3c70-4253-a4b2-52b157be4167', 'Greg from accounting', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1980-05-15', 'Tech Solutions Inc.'),
('4fe25947-ecab-489c-a881-e0057124e408', 'Coworker Fred', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1985-08-20', 'Tech Solutions Inc.'),
('35b175ba-0a27-43e9-bc3f-cf23e1ca2ea7', 'Sister Monica', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1990-12-01', 'Tech Solutions Inc.'),
('7f23057f-77bd-4568-ac64-e933abae9a09', 'Best friend Julia', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1992-03-10', 'Tech Solutions Inc.'),
('84edd1b9-89a5-4107-a84d-435676c2b8f5', 'Mom', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1975-07-25', 'Tech Solutions Inc.'),
('8fb2bd75-9aec-4cc5-b77b-a95f06081388', 'Pizza and burgers', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1988-11-30', 'Fast Food Chain'),
('b621650d-4a81-4016-a917-4a8a4992aaef', 'Uncle Jeff', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1983-02-14', 'Great Outdoors Co.'),
('933e1c6b-887f-4740-9694-870020108906', 'Alice Smith', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1995-06-05', 'Fashion Hub'),
('02672776-8575-4749-8041-9a7428805f42', 'Bob Johnson', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1987-09-12', 'Tech Innovations'),
('286d8048-b4b1-4c07-9759-33512e096472', 'Charlie Brown', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1993-04-22', 'Green Energy Solutions'),
('5e2f9859-9941-4712-9844-48601614945d', 'David Lee', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1986-01-30', 'Global Logistics Inc.'),
('02760233-a615-4654-8c81-4560d268a0a9', 'Eve Wilson', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1991-10-05', 'Green Valley Farms'),
('866d9f0f-0749-417c-a02b-a01494d4d126', 'Frank Garcia', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1982-08-15', 'Urban Design Studio'),
('8685141e-f3b1-4a46-886f-22a49800d923', 'Grace Rodriguez', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1994-12-20', 'Healthy Living Clinic'),
('213c4155-22d7-4c03-b072-f8150499d63c', 'Henry Martinez', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1989-03-25', 'Victory Sports'),
('09d57a6e-71c1-4b13-a442-99890a8a8167', 'Ivy Anderson', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1998-07-30', 'Artisan Crafts'),
('654877d5-d97a-493e-8c83-75b282496a75', 'Jack Thomas', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1984-11-10', 'Electro World'),
('76850f4a-73d7-4008-8e81-f5383f9828d1', 'Kelly Jackson', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1990-02-28', 'Visionary Tech'),
('137d2f92-963d-4c5e-8848-0c64188b3943', 'Liam White', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1996-05-18', 'White Star Logistics'),
('9a502479-7a32-485a-b9c1-7917818e385b', 'Mia Harris', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1997-08-22', 'Harris Consulting'),
('09867990-2646-444a-93a8-444391690412', 'Noah Martin', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1981-04-14', 'Tech Solutions Inc.'),
('1c0d3810-7451-412e-ab51-939e14a1f599', 'Olivia Thompson', 'auth0|66f81f7d9caecc11cdab18d6', CURRENT_TIMESTAMP, '1999-09-09', 'Olivia Thompson Designs');
