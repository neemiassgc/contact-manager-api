...
public class ConstrainedContact {
    ...
    private final Map<
        @contact.manager.api.contact.constraint.Max(value = 15, message = "label is too long")
        @contact.manager.api.contact.constraint.Min(value = 3, message = "label is too short") String,
