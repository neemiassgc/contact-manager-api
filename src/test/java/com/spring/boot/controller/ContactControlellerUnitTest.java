...
public class ContactControlellerUnitTest {
    ...
    public class TestCasesForJoe {
        ...
        void should_response_all_the_contacts_with_OK_200() throws Exception {
            ...
            verify(contactManagerService, once()).findAllByUsername(eq("joe"));
        ...
        void should_return_a_contact_with_OK_200() throws Exception {
            ...
            verify(contactManagerService, once()).findByIdWithUser(eq(contactId), eq("joe"));
            verifyNoMoreInteractions(contactManagerService);
        }
        ...
        void should_update_isolated_fields_of_a_contact_successfully() throws Exception {
            ...
            verify(contactManagerService, once()).updateWithUser(any(Contact.class), eq("joe"));
            verifyNoMoreInteractions(contactManagerService);
        }
    ...
    public class TestCasesForRobert {
        ...
        void should_return_all_the_contacts_with_OK_200() throws Exception {
            ...
            verify(contactManagerService, once()).findAllByUsername(eq("robert"));
            verifyNoMoreInteractions(contactManagerService);
        }
        ...
        void should_return_a_contact_with_OK_200() throws Exception {
            ...
            verify(contactManagerService, once()).findByIdWithUser(eq(contactId), eq("robert"));
            verifyNoMoreInteractions(contactManagerService);
        }
        ...
        void should_update_isolated_fields_of_a_contact_successfully() throws Exception {
            ...
            verify(contactManagerService, once()).updateWithUser(any(Contact.class), eq("robert"));
            verifyNoMoreInteractions(contactManagerService);
        }
        ...
        void should_delete_a_contact_successfully() throws Exception {
            ...
            verify(contactManagerService, once()).deleteByIdWithUser(eq(contactId), eq("robert"));
            verifyNoMoreInteractions(contactManagerService);
        }
    }
